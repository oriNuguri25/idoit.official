        ...
        <section className="max-w-[1400px] mx-auto px-4 md:px-6 py-12">
          <div className="mb-10">
            ...
            <h1 className="text-4xl font-extrabold mb-2 leading-tight tracking-tight">
              Explore Failed Challenges
            </h1>
            <p className="text-zinc-500 text-lg">
              Learn from the community's honest failures and bold attempts.
            </p>
          </div>
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {challenges.map((c) => (
                <ExperimentCard
                  ...
                  category={c.category}
                  color={c.color || "from-rose-500 to-rose-700"}
                  likes={c.likes || 0}
...
export default FailureChallenge;
